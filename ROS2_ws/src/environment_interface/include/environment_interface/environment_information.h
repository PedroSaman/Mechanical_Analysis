...
#define INSERT_DISTANCE 4*block_size_x
#define GRIPPER_POSITION_TO_PICK_CORRECTION 0.2
#define POSITION_TO_PICK_DISTANCE 5.0
#define POSITION_TO_RETREAT 3.0
...
#define DESCEND_TO_PICK 2
#define CLOSE_GRIPPER 3
#define ASCEND_WITH_BLOCK 4
#define POSITION_TO_PLACE 5
#define DESCEND_TO_PLACE 6
#define OPEN_GRIPPER 7
#define RETREAT_FROM_STRUCTURE 8
#define GO_HOME 9