...
ub( (3*force_f + 3):3:(3*(force_f+force_nz)), 1) = T/2;  %Ffz(z) = 0
ub( (3*(force_f+force_nz) + 1):3:(3*(force_f+force_nz+force_nx) - 2), 1) = T/2;  %Ffx(x) = 0
ub( (3*(force_f+force_nz+force_nx) + 2):3:(3*force - 1), 1) = T/2;  %Ffy(y) = 0
%% Linear inequalities
%Cmaxを評価するのは凸の数
...
%% dummy
%beq(9:11) = [M*g+686.7;  1087.3;  1373.4]
%% Solve proble
f = zeros(3*force+1, 1);
f((3*force + 1), 1) = 1;
