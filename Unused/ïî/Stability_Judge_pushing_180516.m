...
%lb(1:3:(3*force_f-2), 1, 1) = -T;  %Ff(x) = 0
%lb(2:3:(3*force_f-1), 1) = -T;  %Ff(y) = 0
%% Upper bounds
...
%ub(1:3:(3*force_f-2), 1, 1) = T;  %Ff(x) = 0
%ub(2:3:(3*force_f-1), 1) = T;  %Ff(y) = 0
%% Linear inequalities
%Cmaxを評価するのは凸の数
...
beq
%% dummy
%beq(9:11) = [M*g+1373.4;  0;  -3605.175]  %fail_1.dat
%beq(15:17) = [M*g+1373.4;  0;  -3605.175]  %fail_5.dat
%beq(9:11) = [M*g+1373.4;  3605.175;  0]  %fail_6.dat
%beq(15:17) = [M*g+1373.4;  3605.175;  0]  %fail_7.dat
%% Solve proble
f = zeros(3*force+1, 1);
f((3*force + 1), 1) = 1;
