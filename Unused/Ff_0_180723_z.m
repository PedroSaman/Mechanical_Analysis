function Ff = Ff_0_180723_z(model)
%%constant number
% 1*1
...
for n = 1 : count;
   ...
   elseif(model(n, 4) == 12)
       ...
       F(force:(force+5), 6) = [10; 20; -10; 10; -20; -10]; %%垂直抗力の上下限値設定用
   ...
   elseif(model(n, 4) == 21)
       ...
       F((force+6):(force+11), 5) = -0.5 * ones(6, 1);  %座標(z = -0.5)
       F(force:(force+5), 6) = [10; 20; -20; 20; -20; -10]; %%垂直抗力の上下限値設定用
   ...
   elseif(model(n, 4) == 22)
       ...
       %z修正(2*2内部の根本高さを上げる)
       F((force+2):3:(force+5), 5) = -1.0;
       F((force+6):3:(force+9), 5) = -1.0;
       %
       F((force+12):(force+23), 3:5) = Pf_22_0;  %座標(z = -0.5)
       F((force+12):(force+23), 5) = -0.5 * ones(12, 1);  %座標(z = -0.5)
       F(force:(force+11), 6) = [10; 20; -10; 10; -20; -10; 10; 20; -10; 10; -20; -10]; %%垂直抗力の上下限値設定用
