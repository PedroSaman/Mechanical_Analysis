...
%"../../Models/Assembly Plans/" path.
%
%input: filename: only the file name, without file type
%OBS: This function assumes that the .txt file "filename" is located in 
% "../../Models/Block Models/". If a new place is desired,
% change the "directory" variable.

    %% Read the block model
    directory = "../../Models/Block Models/";
    incomplete_plans = convertStringsToChars("../../Models/Assembly Plans/Incomplete_Plans/incomplete_" + file_name + "/");
